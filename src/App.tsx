...
// Custom SVG Logo for perfect clarity at any resolution - Ultra Detailed Version with Light/Dark Mode Contrast
const MotazinLogo = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" fill="none" strokeLinecap="round" strokeLinejoin="round" className={`stroke-[url(#motazin-gradient-light)] dark:stroke-[url(#motazin-gradient-dark)] ${className || ''}`}>
    ...
    {/* Concentric subtle background rings for depth - Removed as requested */}
