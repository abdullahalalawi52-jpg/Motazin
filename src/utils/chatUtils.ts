...
export const KEYWORDS: Record<string, { keywords: string[], replyKey: string, weight?: number }[]> = {
  ar: [
    ...
    { keywords: ['معادله', 'ميزانيه', 'قيد', 'اصل', 'خصم', 'حقوق', 'مدين', 'دائن', 'محاسبي', 'توازن', 'متوازن', 'متزنه', 'دفتر قيد', 'راس المال'], replyKey: 'equation', weight: 10 },
    { keywords: ['كيف', 'استخدام', 'بدء', 'طريق', 'بدا', 'تعليم', 'دليل', 'مبتدء', 'شرح', 'خطوات', 'شلون', 'كيفيه'], replyKey: 'howto', weight: 3 },
    { keywords: ['تقرير', 'قائمه', 'دخل', 'تدفق', 'pdf', 'csv', 'تصدير', 'طباعه', 'تحميل', 'حفظ تقرير', 'كشف'], replyKey: 'report', weight: 10 },
    { keywords: ['معامله', 'اضافه', 'ادخال', 'تسجيل', 'تعديل', 'حذف', 'جديد', 'امسح', 'عدل', 'سجل', 'اضيف', 'عمليه'], replyKey: 'transaction', weight: 10 },
    { keywords: ['تواصل', 'اتصال', 'مطور', 'بريد', 'ايميل', 'رساله', 'رقم', 'هاتف', 'اتصل', 'مساعده', 'الدعم', 'فريق'], replyKey: 'contact', weight: 10 },
    { keywords: ['حساب', 'اصول', 'خصوم', 'ملكيه', 'دفتر', 'شجره الحسابات', 'تصنيف', 'بنك', 'نقد', 'كاش'], replyKey: 'accounts', weight: 10 },
    { keywords: ['تنبيه', 'حد', 'تجاوز', 'ميزانيات', 'انذار', 'ميزانيه الحساب', 'ميزانيه حساب'], replyKey: 'budgets', weight: 10 },
    { keywords: ['اهلاك', 'استهلاك', 'اطفاء', 'خرده', 'عمر', 'اصل ثابت', 'اصول ثابته', 'حاسبه الاهلاك'], replyKey: 'depreciation', weight: 15 },
    { keywords: ['مسح', 'صوره', 'استيراد', 'رفع', 'ملف', 'scan', 'ocr', 'tesseract', 'فاتوره', 'كاميرا'], replyKey: 'scans', weight: 10 },
    { keywords: ['نصيح', 'تلميح', 'اختصار', 'مختصر', 'سريع', 'ميزه', 'افضل', 'طريقة صحيحه', 'ارشادات'], replyKey: 'tips', weight: 3 },
    { keywords: ['ذكاء', 'ai', 'gemini', 'api', 'مفتاح', 'تطوير', 'جيميني', 'شات', 'مساعد ذكي', 'تفعيل'], replyKey: 'aiMode', weight: 10 },
  ],
  en: [
    { keywords: ['hello', 'hi', 'hey', 'greeting', 'good morning', 'good evening', 'howdy', 'sup', 'welcome', 'yo', 'how are you'], replyKey: 'greeting', weight: 5 },
    { keywords: ['equation', 'account', 'balance', 'asset', 'liability', 'equity', 'formula', 'debit', 'credit', 'double entry', 'capital', 'journal'], replyKey: 'equation', weight: 10 },
    { keywords: ['how', 'use', 'start', 'begin', 'guide', 'tutorial', 'beginner', 'instruction', 'help', 'steps', 'explain'], replyKey: 'howto', weight: 3 },
    { keywords: ['report', 'statement', 'income', 'cash flow', 'pdf', 'csv', 'export', 'print', 'download', 'save'], replyKey: 'report', weight: 10 },
    { keywords: ['transaction', 'add', 'entry', 'record', 'journal', 'edit', 'delete', 'remove', 'new', 'modify', 'insert'], replyKey: 'transaction', weight: 10 },
    { keywords: ['contact', 'email', 'developer', 'support', 'message', 'phone', 'call', 'reach', 'helpdesk'], replyKey: 'contact', weight: 10 },
    { keywords: ['account', 'asset', 'liability', 'equity', 'chart', 'ledger', 'coa', 'bank', 'cash'], replyKey: 'accounts', weight: 10 },
    { keywords: ['budget', 'alert', 'limit', 'warning', 'exceed', 'track', 'threshold'], replyKey: 'budgets', weight: 10 },
    { keywords: ['depreciation', 'deprec', 'amortization', 'salvage', 'useful life', 'straight line', 'asset life'], replyKey: 'depreciation', weight: 15 },
    { keywords: ['scan', 'pdf', 'image', 'import', 'upload', 'file', 'ocr', 'tesseract', 'extract', 'invoice', 'camera'], replyKey: 'scans', weight: 10 },
    { keywords: ['tip', 'trick', 'shortcut', 'quick', 'feature', 'best', 'advice', 'recommend'], replyKey: 'tips', weight: 3 },
    { keywords: ['ai', 'gemini', 'api', 'key', 'intelligence', 'smart', 'gpt', 'llm', 'chat', 'activate'], replyKey: 'aiMode', weight: 10 },
  ]
};
